...
contract ERC20KPITokenIntermediateAnswerMultiRewardRecoverTest is BaseTestSetup {
    ...
    function testIntermediateAnswerAndRelationshipSingleOracleZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 2, minimumPayout: 0});
        _rewards[1] = Reward({token: address(secondErc20), amount: 3 ether, minimumPayout: 0});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 100 ether, false);
    ...
    function testIntermediateAnswerAndRelationshipSingleOracleNonZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 10 ether, minimumPayout: 1 ether});
        _rewards[1] = Reward({token: address(secondErc20), amount: 102 ether, minimumPayout: 91.5 ether});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 10 ether, false);
    ...
    function testIntermediateAnswerOrRelationshipSingleOracleZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 2 ether, minimumPayout: 0});
        _rewards[1] = Reward({token: address(secondErc20), amount: 4 ether, minimumPayout: 0});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 100 ether, false);
    ...
    function testIntermediateAnswerOrRelationshipSingleOracleNonZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 45 ether, minimumPayout: 22 ether});
        _rewards[1] = Reward({token: address(secondErc20), amount: 821 ether, minimumPayout: 38 ether});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 100 ether, false);
    ...
    function testIntermediateAnswerAndRelationshipMultipleOraclesZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 2 ether, minimumPayout: 0});
        _rewards[1] = Reward({token: address(secondErc20), amount: 4 ether, minimumPayout: 0});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 100 ether, false);
    ...
    function testIntermediateAnswerAndRelationshipMultipleOraclesNonZeroMinimumPayoutMultiRewardExpired() external {
        Reward[] memory _rewards = new Reward[](2);
        _rewards[0] = Reward({token: address(firstErc20), amount: 2 ether, minimumPayout: 1 ether});
        _rewards[1] = Reward({token: address(secondErc20), amount: 26 ether, minimumPayout: 10 ether});
        bytes memory _erc20KpiTokenInitializationData = abi.encode(_rewards, "Test", "TST", 100 ether, false);
