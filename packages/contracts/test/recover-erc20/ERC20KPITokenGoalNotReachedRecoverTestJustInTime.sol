...
contract ERC20KPITokenGoalNotReachedRecoverTestJustInTime is BaseTestSetup {
    function testGoalNotReachedAndRelationshipSingleOracleZeroMinimumPayoutJustInTimeFunding() external {
    ...
    function testGoalNotReachedAndRelationshipSingleOracleZeroMinimumPayoutExpiredJustInTimeFunding() external {
        Reward[] memory _rewards = new Reward[](1);
    ...
    function testGoalNotReachedAndRelationshipSingleOracleNonZeroMinimumPayoutMultiReward() external {
        ...
        assertEq(firstErc20.balanceOf(address(this)), 2);
        assertEq(firstErc20.balanceOf(address(kpiTokenInstance)), 0);
        assertEq(secondErc20.balanceOf(address(this)), 7 ether);
        assertEq(secondErc20.balanceOf(address(kpiTokenInstance)), 0);
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
        kpiTokenInstance.recoverERC20(address(firstErc20), address(this));
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
    ...
    function testGoalNotReachedOrRelationshipSingleOracleNonZeroMinimumPayoutMultiReward() external {
        ...
        assertEq(firstErc20.balanceOf(address(this)), 2);
        assertEq(firstErc20.balanceOf(address(kpiTokenInstance)), 0);
        assertEq(secondErc20.balanceOf(address(this)), 3.5 ether);
        assertEq(secondErc20.balanceOf(address(kpiTokenInstance)), 0);
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
        kpiTokenInstance.recoverERC20(address(firstErc20), address(this));
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
    ...
    function testGoalNotReachedAndRelationshipMultipleOraclesNonZeroMinimumPayoutMultiReward() external {
        ...
        assertEq(firstErc20.balanceOf(address(this)), 2);
        assertEq(firstErc20.balanceOf(address(kpiTokenInstance)), 0);
        assertEq(secondErc20.balanceOf(address(this)), 40 ether);
        assertEq(secondErc20.balanceOf(address(kpiTokenInstance)), 0);
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
        kpiTokenInstance.recoverERC20(address(firstErc20), address(this));
        vm.expectRevert(abi.encodeWithSignature("NothingToRecover()"));
